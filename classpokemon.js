...
// constructor = crée des parametres
// isLucky = boolean qui provoque aléatoirement une action
...
let bulbizarre=new Pokemon('Bulbizarre',18,4,70,0.8);

while(dracofeu.hp >0 && bulbizarre.hp>0){
    dracofeu.attackPokemon(bulbizarre)
    if(bulbizarre.hp<=0){
        console.log(bulbizarre.name+" is dead !");
        break;
    }
    bulbizarre.attackPokemon(dracofeu)
    if(dracofeu.hp<=0){
